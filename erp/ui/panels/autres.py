            ...
            with table_container:
                ...
                for idx, devis in enumerate(app_instance.dm.devis_list):
                    ...
                    with ui.row().classes('w-full gap-2 px-2 py-0.5 items-center hover:bg-gray-50 text-sm border-b border-gray-200'):
                        ...
                        ui.select(options=statut_options, value=current_devis.statut, on_change=make_statut_handler(current_devis)).classes('w-32').props('size=sm dense borderless').style('text-align: center;')
